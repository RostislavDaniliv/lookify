...
class GeminiClient:
    def __init__(self):
        ...
        if not settings.GOOGLE_API_KEY and settings.USE_GEMINI:
            logger.warning("GOOGLE_API_KEY is not configured, but USE_GEMINI=True. GeminiClient will not function properly.")
